...
\COPY tabla_peliculas FROM '/Users/aarroyo/Desktop/Desafíos módulo 7/1.- Bases de datos relacionales/Desafíos evaluados/Apoyo Desafío - Top 100/peliculas.csv' csv header;
-- Importar datos del archivo reparto.CSV
\COPY tabla_reparto FROM '/Users/aarroyo/Desktop/Desafíos módulo 7/1.- Bases de datos relacionales/Desafíos evaluados/Apoyo Desafío - Top 100/reparto.csv' csv header;
